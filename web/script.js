...
const attribution =
  '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributonrs';
...
tiles.addTo(map);
const api_url =
  "https://opensky-network.org/api/states/all?lamin=35.8389&lomin=25&lamax=45&lomax=45";
    ...
    states.forEach((state) => {
      ...
      if (markers[icao24]) {
        ...
        markers[icao24] = L.marker([lat, lng], {
          ...
          `<p> Ülke: ${origin_country} <br> Enlem: ${lat} <br> Boylam: ${lng} <br> Barometrik Yükseklik: ${baro_altitude} m</p>`
        );
